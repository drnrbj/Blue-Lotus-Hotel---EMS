...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // ── Leave — All authenticated users (employees can view their own) ──
    Route::middleware('auth:sanctum')->prefix('leave-requests')->group(function () {
        Route::get('/my-requests', [LeaveController::class, 'myRequests']);  // New endpoint
    });

    // Also allow employees to create leave requests
    Route::middleware('auth:sanctum')->post('/leave-requests', [LeaveController::class, 'store']);
    ...
    Route::middleware('role:Admin,HR')->prefix('new-hires')->group(function () {
